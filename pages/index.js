...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Star Store - Shop what you think!</title>
        <meta name="description" content="Star Store - Wear and shop whatever you want!" />
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Star Store - Shop what you think!</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Shop whatever you think, whatever you want because what you think we sell. Just go for it!</p>
          </div>
